...
submit_button = Button(main_window, text="Submit info", command=submit).place(x=10, y=35)
...
# Code has the delete function and does the basic input
# However it doesn't account for errors
